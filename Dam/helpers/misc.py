...
CBHDSYS = "https://github.com/d4msy/Dam-Userbot"
...
def git():
    ...
    try:
        repo = Repo()
        LOGGER("Dam").info(f"Git Client Found")
    except GitCommandError:
        LOGGER("Dam").info(f"Invalid Git Command")
        ...
        LOGGER("Dam").info("Fetched Latest Updates")
    ...
    if is_heroku:
        if HEROKU_API_KEY and HEROKU_APP_NAME:
            try:
                ...
                LOGGER("Dam").info(f"Heroku App Configured")
